...
<header>
    ...
    <div class="logout-container" id="logout-container">
        <div class="logout-section-1">
            ...
            <div class="username-container">
                ...
                <button class="btn-edit-user" id="btn-edit-user"><img src="../../img/pencil-edit-user.png" 
                data-bs-toggle="modal">
                </button>

            </div>
            <p id="logout-tipoUsuario">Tipo_usuario</p>
        </div>
        <div class="logout-section-2">
            <div class="items-info-section">
                <img src="../../img/personal-icon.png" class="img-user-info">
                <p id="logout-ci">12345678</p>
            </div>
            <div class="items-info-section">
                <img src="../../img/mail.png" class="img-user-info">
                <p id="logout-mailPersonal">example@gmail.com</p>
            </div>
            <div class="items-info-section">
                <img src="../../img/phone.png" class="img-user-info">
                <p id="logout-telefono">099 999 999</p>
            </div>
        </div>
    ...
    <div class="sidebar show">
        <ul>
            <li>
                <a href="../../html/Usuarios/CreateReserva.html" class="a-padding">
                    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                        fill="#e8eaed">
                        <path
                            d="M440-280h80v-160h160v-80H520v-160h-80v160H280v80h160v160Zm40 200q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-80q134 0 227-93t93-227q0-134-93-227t-227-93q-134 0-227 93t-93 227q0 134 93 227t227 93Zm0-320Z" />
                    </svg>
                    <span class="text-nueva-reserva">Nueva Reserva</span>
                </a>
            </li>
            <button class="dropdown-btn" onclick=toggleSubMenu(this)>
                ...
                <span class="text-reservas">Reservas</span>
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                    fill="#e8eaed">
            ...
            <ul class="sub-menu">
                <li><a href="../../html/Usuarios/CreateReserva.html">• Crear reserva</a></li>
                <li><a href="../../html/Institucion/ManageReservas.html">• Mis reservas</a></li>
                <li><a href="../../html/Institucion/ManageCalendar.html">• Calendario</a></li>
            ...
            <button class="dropdown-btn dropdown-btn-instituciones" onclick=toggleSubMenu(this)>
                ...
                <span class="text-instituciones">Instituciones</span>
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                    fill="#e8eaed">
                    <path d="M480-360 280-560h400L480-360Z" />
                </svg>
...
function updateDropdownBehavior() {
  if ($('.sidebar').hasClass('open')) {
    ...
    $('.dropdown-btn').off('click').on('click', function () {
      ...
      window.location.href = '../../html/Institucion/ManageReservas.html';
    });
  }
...
$(document).ready(function () {
  ...
  $.ajax({
    ...
    success: function(response) {
      ...
      if (response.logueado) {
        ...
        $('#logout-telefono').text(response.telefono);
        $('#logout-ci').text(response.ci);
        $('#logout-mailPersonal').text(response.mail_personal);
        $('logout-tipoUsuario').text(response.tipo_empleado);
      } else {
  ...
  showNavbar(); //Llama a la funcion para mostrar el navbar y sidebar 
