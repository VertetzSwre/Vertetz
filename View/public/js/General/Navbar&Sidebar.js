...
<!--SIDEBAR-->
    <div class="sidebar">
      <hr>
        <a href="CreateReserva.html">Nueva Reserva</a>
      <hr>
...
<!--CONTENIDO DEL DROPDOWN 1-->
  <div class="dropdown-content">
    <ul>
      <li><a href="CreateReserva.html">Crear reserva</a></li>
      <li><a href="MyReservas.html">Mis reservas</a></li>
...
<!--CONTENIDO DEL DROPDOWN 2-->
  <div class="dropdown-content2">
    <ul>
      ...
      <li><a href="CreateInstitucion.html">Crear institucion</a></li>
...
$(document).ready(function () {
  ...
  $('.dropdown-toggle').on('click', function (event) {
    if (!$(event.target).hasClass('dropdown-icon')) {
      window.location.href = 'ManageReserva.html';
    }
  });
