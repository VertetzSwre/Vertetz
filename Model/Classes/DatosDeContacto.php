...
class DatosDeContacto extends Connection
{
    ...
    public function actualizarDatosDeContacto($nombre_institucion, $email, $telefono)
    {
        $conn = $this->getConnection();

        try {
            $sql = "UPDATE datos_de_contacto 
                SET email = :email, telefono = :telefono 
                WHERE nombre_institucion = :nombre_institucion";
            ...
            return [
                'estado' => 'Error al actualizar datos de contacto.',
                'error' => $e->getMessage()
            ];
        } finally {
            $this->closeConnection();
    ...
    public function eliminarDatosDeContacto($nombre_institucion)
    {
        $conn = $this->getConnection();

        try {
            $sql = "DELETE FROM datos_de_contacto WHERE nombre_institucion = :nombre_institucion";
            ...
            return [
                'estado' => 'Error al eliminar datos de contacto.',
                'error' => $e->getMessage()
            ];
        } finally {
            $this->closeConnection();
